...
function preload ()
{
    ...
    this.load.image('bomb', '/src/JsGames/assets/bomb.gif');
    this.load.spritesheet('dude', '/src/JsGames/assets/dude.png', { frameWidth: 32, frameHeight: 48 }); 
    this.load.audio('audiodao', '/src/JsGames/assets/audio/test.ogg');
    this.load.audio('collected', '/src/JsGames/assets/audio/collect.ogg');
    this.load.audio('died', '/src/JsGames/assets/audio/laugh.ogg');
    this.load.audio('bombsaway', '/src/JsGames/assets/audio/bomb.ogg');
